...
function builder(options) {
  ...
  if (!options.network) {
    options.network = divicore.Networks.defaultNetwork;
  }

  options.Block = options.Block || divicore.Block;
  options.BlockHeader = options.BlockHeader || divicore.BlockHeader;
  options.Transaction = options.Transaction || divicore.Transaction;
  options.MerkleBlock = options.MerkleBlock || divicore.MerkleBlock;
