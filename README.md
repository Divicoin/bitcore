...
- [Divicore Lib](packages/divicore-lib) - A pure and powerful JavaScript Bitcoin library
...
- [Divicore P2P](packages/divicore-p2p) - The peer-to-peer networking protocol for BTC
